...
namespace MarkLight.Editor
{
    ...
    public class Configuration : ScriptableObject
    {
        ...
        public Configuration()
        {
            ...
            ViewPaths.Add("Assets/Plugins/MarkLight/Views/");
            SchemaFile = "Assets/Plugins/MarkLight/Views/Schemas/MarkLight.xsd";
        }
        ...
        public static Configuration Instance
        {
            get
            {
                ...
                Configuration configuration = AssetDatabase.LoadAssetAtPath("Assets/Resources/MarkLight/Configuration.asset", typeof(Configuration)) as Configuration;
                ...
                System.IO.Directory.CreateDirectory("Assets/Resources/MarkLight/");
                configuration = ScriptableObject.CreateInstance<Configuration>();
                AssetDatabase.CreateAsset(configuration, "Assets/Resources/MarkLight/Configuration.asset");
